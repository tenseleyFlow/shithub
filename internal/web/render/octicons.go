...
func BuiltinOcticons() OcticonResolver {
	...
	icons := map[string]template.HTML{
		...
		"clock": trustedSVG(`<svg xmlns="http://www.w3.org/2000/svg" ` + cls +
			`><path d="M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8.75-3.25v3.06l2.03 2.03a.75.75 0 1 1-1.06 1.06L7.47 9.15a.75.75 0 0 1-.22-.53V4.75a.75.75 0 0 1 1.5 0Z"/></svg>`),
		"stop": trustedSVG(`<svg xmlns="http://www.w3.org/2000/svg" ` + cls +
			`><path d="M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm5.75-2.5h4.5a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-.75.75h-4.5a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 1 .75-.75Z"/></svg>`),
		...
		"arrow-switch": trustedSVG(`<svg xmlns="http://www.w3.org/2000/svg" ` + cls +
			`><path d="M5.22 14.78a.75.75 0 0 0 1.06-1.06L4.56 12h8.69a.75.75 0 0 0 0-1.5H4.56l1.72-1.72a.75.75 0 0 0-1.06-1.06l-3 3a.75.75 0 0 0 0 1.06l3 3Zm5.56-6.5a.75.75 0 1 1-1.06-1.06l1.72-1.72H2.75a.75.75 0 0 1 0-1.5h8.69L9.72 2.28a.75.75 0 0 1 1.06-1.06l3 3a.75.75 0 0 1 0 1.06Z"/></svg>`),
		"person-add": trustedSVG(`<svg xmlns="http://www.w3.org/2000/svg" ` + cls +
