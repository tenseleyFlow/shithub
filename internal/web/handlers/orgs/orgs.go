...
func (h *Handlers) MountCreate(r chi.Router) {
	...
	r.Post("/organizations/{org}/settings/security/secret-patterns/{patternID}/enable", h.settingsSecretPatternEnable)
	r.Post("/organizations/{org}/settings/security/secret-patterns/{patternID}/disable", h.settingsSecretPatternDisable)
	r.Post("/organizations/{org}/settings/security/secret-patterns/{patternID}/delete", h.settingsSecretPatternDelete)
