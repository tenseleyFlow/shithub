...
func (h *Handlers) MountRepoHome(r chi.Router) {
	...
	r.Get("/{owner}/{repo}/security/sbom", h.repoSBOM)
	r.Post("/{owner}/{repo}/security/sbom/generate", h.repoSBOMGenerate)
	r.Get("/{owner}/{repo}/security/sbom/download", h.repoSBOMDownload)
	r.Get("/{owner}/{repo}/security/attestations", h.repoAttestations)
	r.Post("/{owner}/{repo}/security/attestations", h.repoAttestationCreate)
	r.Get("/{owner}/{repo}/security/attestations/{attestationID}/download", h.repoAttestationDownload)
