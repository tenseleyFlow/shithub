...
func (h *Handlers) MountSettingsGeneral(r chi.Router) {
	...
	r.Get("/{owner}/{repo}/settings/tags", h.settingsPlaceholder("tags", "Tags", "Tag-protection rules are managed from the repository rules section on Settings → Branches."))
}
